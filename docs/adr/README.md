...
| [0039](0039-size-from-ops-002s-measurements-and-retire-doc-05-4s-estimates.md) | Size the deployment from OPS-002's measurements, and record what each measured number replaces in doc 05 §4 | accepted | 2026-09-01 |
