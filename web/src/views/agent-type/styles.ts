...
/*
 * The class strings the agent-type view uses, and the only file in this directory
 ...
 * directory or in views/repo names a `bg-` or `border-` utility, so a
...
/** A list that stacks inside a dense table cell. */
