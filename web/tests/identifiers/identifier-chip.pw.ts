...
/*
 * FE-092 (proposed; doc 07 has no id for this — see the PR/issue report) —
...
test.describe("FE-092: identifier chip — full value reaches assistive technology", () => {
  test("the glyphs on screen are truncated, but the accessible name carries the full value", async ({
    ...
    // full, untruncated identifier. This is the assertion FE-092 exists for:
